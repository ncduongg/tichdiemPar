                                    ...
                                    <div class="m-sm-4">
                                        <form type="submit" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control form-control-lg" type="text" name="phone" required="required"
                                                       placeholder="Điền số điện thoại khách hàng"/>
                                            </div>
                                            <div class="text-center mt-3">
                                                 <button type="submit" class="btn btn-lg btn-primary"><i data-feather="save"></i> Lưu</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
