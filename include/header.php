        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="./infoNhanvien.php"><i class="align-middle me-1"
                                                                          data-feather="user"></i> Thông tin</a>
                    <a class="dropdown-item" href="#"><i class="align-middle me-1" data-feather="pie-chart"></i>
                        Thống kê</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="./editNhanVien.php"><i class="align-middle me-1"
                                                                  data-feather="settings"></i> Cài đặt</a>
                    <a class="dropdown-item" href="https://www.ncduong.info/@NC.Duong/"><i class="align-middle me-1"
